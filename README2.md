...
2.An spred operator expands element of an array, object or iterate into individual value.

3.
map: map crates a new array by transforming every elment of the original array.
filter: filter creates a new array with elements that pass a condition.
foreach: foreach executes a funtion for each element, but doesn't return a new array.
